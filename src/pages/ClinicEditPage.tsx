...
function FieldRow({ label, required, children }: FieldRowProps) {
  return (
    <div className="flex items-start py-4 border-b border-border last:border-b-0">
      <div className="w-48 shrink-0 text-sm text-muted-foreground pt-2">{label}</div>
      <div className="flex items-center gap-2">
        {required && (
          <span className="text-xs text-destructive border border-destructive/50 rounded px-1.5 py-0.5 shrink-0">
            必填*
          </span>
        )}
      </div>
...
export default function ClinicEditPage() {
  ...
  return (
    <div>
      ...
      <div className="bg-card rounded-lg shadow-sm p-6 max-w-3xl">
        ...
        <FieldRow label="Line Channel ID" required>
          <Input
        ...
        <FieldRow label="Line Channel Token" required>
          <Input
        ...
        <FieldRow label="Line Channel Secret" required>
          <Input
        ...
        <FieldRow label="Web Hook">
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => copyToClipboard(form.webHook)}
        ...
        <FieldRow label="Line Login ID" required>
          <Input
        ...
        <FieldRow label="Line Login Secret" required>
          <Input
        ...
        <FieldRow label="Line Login Call Back">
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => copyToClipboard(form.lineLoginCallback)}
              className="text-sm shrink-0"
            >
              複製網址
            </Button>
        ...
        <FieldRow label="問卷網址">
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => copyToClipboard(form.surveyUrl)}
              className="text-sm shrink-0"
            >
              複製網址
            </Button>
